            ...
            <div className="h-[28rem] bg-gray-100/75 w-full mt-6">
                <div className="lg:px-36 p-3 flex items-center justify-between">
                    ...
                    <div className='w-full'>
                        <TextTemplate title={"Lighting Fast File Processing"} icon={<BsSpeedometer />} caption={'Experiece a new level of speed and efficiency in processing your files.'} />
                        <TextTemplate title={"Lighting Fast File Processing"} icon={<GiCheckedShield />} caption={'Experiece a new level of speed and efficiency in processing your files.'} />
                        <TextTemplate title={"Lighting Fast File Processing"} icon={<LuFileStack />} caption={'Experiece a new level of speed and efficiency in processing your files.'} />
                    </div>
